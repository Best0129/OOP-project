...
//        gd.setFullScreenWindow(main_frame);
    ...
    public void actionPerformed(ActionEvent e) {
        if (op.isOk(e)) {
            ...
            String number_of_seat = op.getNumberofseat_txt().getText();
            String price = op.getPrice_txt().getText();
            String diagram_link = op.getDiagram_txt().getText();
            System.out.println(meeting_name + meeting_place + number_of_seat + price + diagram_link);
        } else if (pp.isOk(e)) {
