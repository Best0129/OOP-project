...
public class PageControl extends Total implements ActionListener, WindowListener {
    ...
    public PageControl() {
        ...
        main_frame.setLayout(new CardLayout(250, 120));
        main_frame.add(stp.getFr());
        main_frame.add(hp.getFrame());
        main_frame.add(op.getFrame());
        main_frame.add(pp.getFrame());
        main_frame.add(ppinfo.getFrame());
    ...
    public void sum_price() {
        ...
        for (int i = 0; i<=ParticipantModal.arrlist.toArray().length - 1;i++) {
            if (ParticipantModal.arrlist.get(i).getId().equals(id)) {
                seat++;
    ...
    public void actionPerformed(ActionEvent e) {
         if (pp.isOk(e)) {
            ...
            String selected_seat = ParticipantPage.seat_cb.getSelectedItem().toString();
            String id = ParticipantInfoPage.id_tf.getText();
            ...
            ParticipantModal.arrlist.add(new ParticipantData(id, name, place, selected_seat, price));
